...
//			"/login/**",
			"/api/register", "/messages/*", "/configuration/ui",
			"/configuration/security", "/swagger-ui.html", "/webjars/**" };

	public void WebSecurityConfiguration(UserDetailsService userDetailsService) {
	...
	protected void configure(HttpSecurity httpSecurity) throws Exception {
		...
		httpSecurity.cors().and().csrf().disable().authorizeRequests().antMatchers(AUTH_WHITELIST).permitAll()
				...
				.antMatchers(HttpMethod.POST, "/KynUsers/api/register").permitAll()
